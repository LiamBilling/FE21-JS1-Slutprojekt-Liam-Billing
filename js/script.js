const API_KEY = "34d0cf4099df42f487c0f4db83dca952";
...
userSubmit.addEventListener("click", function (e) {
  ...
  let urlCurrent = `https://api.weatherbit.io/v2.0/current?key=34d0cf4099df42f487c0f4db83dca952&lang=sv&units=m&city=${city}&country=${country}`;
  ...
  if (userInput.value === "") {
    ...
    $(divBorder).on("mouseenter", function () {
      $("#results").css("backgroundColor", "#D3D3D3");
